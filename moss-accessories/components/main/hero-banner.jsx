  ...
  return (
    <div>
      <div className="hidden w-full larger_screens:block overflow-hidden mb-6 md_screens:mb-0">
        <Link href="/about">
          <section className=" relative h-[630px] w-full m-auto bg-[url(@/assets/hero_banner.webp)] larger_screens:bg-contain bg-no-repeat md_screens:bg-contain md_screens:h-[430px] md_screens:mb-0  mb-4">
      ...
      <div className="hidden small_screens:block h-[530px] overflow-hidden mb-6">
        <Link href="/about">
          <section className=" relative h-[630px] w-full m-auto bg-[url(@/assets/hero_mobile-min.jpg)] bg-no-repeat ">
